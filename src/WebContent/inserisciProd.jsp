...
<%
	if (request.getParameter("btnProdottoInserito") != null) {
		//creo il Bean
		...
		if (request.getParameter("prezzo") != null) {
			pb.setPrezzo(Double.parseDouble(request.getParameter("prezzo")));
			//System.out.println(request.getParameter("prezzo"));
		}
		if (request.getParameter("descrizione") != null) {
			pb.setDescrizione(request.getParameter("descrizione"));
		}
		if (request.getParameter("optradioCategoria") != null) {
			
			pb.setCategorie(request.getParameter("optradioCategoria"));
...
// 		}
		...
		%>
		<jsp:forward page="prodottoInserito.jsp"/>
		<%}	 %>
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-12 text-center">
					<h2 class="section-heading">Vendi un prodotto</h2>
					<h3 class="section-subheading text-muted">Inserisci qui il
						prodotto che vuoi mettere in vendita</h3>
				</div>
			</div>
			<div class="row">
				<div class="col-lg-12">
					<form>
						<div class="row">
							<div class="col-md-6">
								...
								<label for="nome" style="color:white">Nome Prodotto:</label>
									<input type="text" class="form-control"
										placeholder="Inserisci il nome del prodotto" name="nome" id="nome"
										required
										data-validation-required-message="Perfavore inserisci il nome del prodotto">
									<p class="help-block text-danger"></p>
								</div>
								<div class="form-group">
								<label for="prezzo" style="color:white">Prezzo Prodotto:</label>
									<input type="number" min="0.00" step="0.01"
										class="form-control"
										placeholder="Inserisci il prezzo del prodotto" name="prezzo" id="prezzo"
										required
										data-validation-required-message="Perfavore inserisci il prezzo del prodotto">
									<p class="help-block text-danger"></p>
								</div>
								<div class="form-group" align="center">
									<label class="radio-inline"><input type="radio"
										name="optradioCategoria" value="Vestiario">
										<p style="color: white">Vestiario</p></label> <label
										class="radio-inline"><input type="radio"
										name="optradioCategoria" value="Casa">
										<p style="color: white">Casa</p></label> <label
										class="radio-inline"><input type="radio"
										name="optradioCategoria" value="Libri/Cd">
							...
							<div class="col-md-6">
								<div class="form-group">
								<label for="descrizione" style="color:white">Descrizione Prodotto:</label>
									<textarea class="form-control" name="descrizione" id="descrizione"
										...
										data-validation-required-message="Per favore descrivi brevemente il tuo prodotto"></textarea>
									<p class="help-block text-danger"></p>
								</div>
							</div>
							...
							<div class="col-lg-12 text-center">
								<div id="success"></div>
								<button type="submit" class="btn btn-xl" name="btnProdottoInserito">Inserisci
									prodotto</button>
