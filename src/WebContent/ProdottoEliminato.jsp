		...
		<div class="container">
			<div class="row">
				<div class="col-lg-12 text-center">
					<h2 class="section-heading" style="color: white">Prodotto Eliminato</h2>
					<h3 class="section-subheading text-muted">Il prodotto � stato eliminato dal sistema</h3>
				</div>
			</div>
			<div class="row">
				<div class="col-lg-12">
					<form action="GestioneProdotto.jsp" method="POST">
						...
						<div class="col-lg-12 text-center">
							<div id="success"></div>
							<button type="submit" class="btn btn-xl" name="btnBackPannello">Torna al pannello</button>
						</div>
					</form>
				</div>
