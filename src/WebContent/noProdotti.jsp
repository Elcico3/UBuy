		...
		<div class="container">
			<div class="row">
				<div class="col-lg-12 text-center">
					<h2 class="section-heading" style="color: white">Non ci sono prodotti</h2>
					<h3 class="section-subheading text-muted">Attualmente nel sistema non � presente alcun prodotto</h3>
				</div>
			</div>
			<div class="row">
				<div class="col-lg-12">
					<form action="GestioneProdotto.jsp" method="POST">
						
						<div class="clearfix"></div>
						<div class="col-lg-12 text-center">
							<div id="success"></div>
							<button type="submit" class="btn btn-xl" name="btnBackPanel">Torna al pannello</button>
						</div>
					</form>
				</div>
