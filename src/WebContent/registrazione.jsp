...
<%
	...
	{		
		...
		ub.setCognome(request.getParameter("cognome"));
...
<body id="page-top">
<body style="background: url(img/header-bg.jpg) no-repeat center center fixed; 
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-12 text-center">
					<h2 class="section-heading" style="color:white">Registrati alla piattaforma</h2>
					<h3 class="section-subheading text-muted">Compila i campi di seguito e inizia a usufruire della piattaforma</h3>
				</div>
			</div>
			<div class="row">
				<div class="col-lg-12">
					<form>
						<div class="row">
							<div class="col-md-12">
								...
								<div class="form-group" align="center">
									<label class="radio-inline"><input type="radio"
										name="optradio" value="Venditore"><p style="color:white"> Venditore </p></label> <label class="radio-inline"><input
										type="radio" name="optradio" value="Compratore" disabled><p style="color:white">Compratore</p></label>
								</div>
							...
							<div class="col-lg-12 text-center">
								<div id="success"></div>
								<button type="submit" class="btn btn-xl" name="btnRegistra">registrati</button>
							</div>
						</form>
						</div>
