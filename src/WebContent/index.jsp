<!DOCTYPE html>
<%@ page errorPage = "PaginaErrore.jsp" %><%@ page import="dominio.*"%>
<%@ page import="bean.*"%>
	...
	<header>
		<div class="container">
			<div class="intro-text">
				<div class="intro-lead-in">Benvenuto su Ubuy</div>
				<div class="intro-heading">Inizia a comprare o vendere prodotti</div>
				<a href="login.jsp" class="page-scroll btn btn-xl">logIn</a>
				<a href="registrazione.jsp" class="page-scroll btn btn-xl">Registrati</a>
			</div>
		</div>
	</header>
