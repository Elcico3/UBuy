...
<body
	...
	<!-- Error Section -->
	<section id="erroreCategoriaInserisciProdotto">
		<div class="container">
			<div class="row">
				<div class="col-lg-12 text-center">
					<h2 class="section-heading" style="color: white">Manca la categoria</h2>
					<h3 class="section-subheading text-muted">Specifica la categoria a cui il prodotto appartiene</h3>
				</div>
			</div>
			<div class="row">
				<div class="col-lg-12">
					<form action="inserisciProd.jsp" method="POST">
						
						<div class="clearfix"></div>
						<div class="col-lg-12 text-center">
							<div id="success"></div>
							<button type="submit" class="btn btn-xl" name="btnBackLogin">Torna indietro</button>
						</div>
					</form>
				</div>
