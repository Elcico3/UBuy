...
%>
<%
	List<ProdottoBean> p = new ArrayList<ProdottoBean>();
	p=pb.ottieniBeanProdottiVenditore();
	if (p.isEmpty()) {
%>
...
<%
	...
	for (int i = 0; i < p.size(); i++) {
		if (request.getParameter("btnElimina" + i) != null) {
// 			System.out.println("hai premuto il bottone: " + i + "\n");
// 			System.out.println("nome prodotto da cancellare:" + p.get(i).getNome() + "\n");
			p.get(i).eliminaProdotto(p.get(i),ub);
%>
<jsp:forward page="ProdottoEliminato.jsp"></jsp:forward>
<%
	}
	}
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-12 text-center">
					<h2 class="section-heading">Elimina un prodotto</h2>
			...
			<div class="row">
				...
				<div class="col-sm-4">
					<div class="team-member">
						<%
							if (p.get(i).getCategorie().equals("Vestiario")) {
						%>
						...
						%>
						<%
							if (p.get(i).getCategorie().equals("Casa")) {
						%>
						...
						%>
						<%
							if (p.get(i).getCategorie().equals("Libri/Cd")) {
						%>
						...
						%>
						<p style="color: white"><%=p.get(i).getNome()%></p>

						<p class="text-muted"></p>
						<form>
							<button type="submit" class="btn btn-xl" name="btnElimina<%=i%>">Elimina</button>
						</form>
					</div>
				</div>
				<%
