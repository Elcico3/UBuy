...
<%
	...
	if (request.getParameter("btnProdotto") != null) {
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-12 text-center">
					<h2 class="section-heading">Il tuo prodotto � stato correttamente inserito</h2>
					<h3 class="section-subheading text-muted">Premi ok per tornare al pannello</h3>
				</div>
			</div>
			<form action="prodottoInserito.jsp" method="POST">
			<div class="clearfix"></div>
			<div class="col-lg-12 text-center">
				<div id="success"></div>
				<button type="submit" class="btn btn-xl" name="btnProdotto">OK</button>
			</div>
			</form>
		</div>
	</section>
