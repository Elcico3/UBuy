		...
		<div class="container">
			<div class="row">
				<div class="col-lg-12 text-center">
					<h2 class="section-heading" style="color: white">Benvenuto!</h2>
					<h3 class="section-subheading text-muted">Cosa vuoi fare?</h3>
				</div>
			</div>
			<div class="row">
				<div class="col-sm-4">
					<div class="team-member">
						<a href="inserisciProd.jsp"><img
							src="img/prodotti/inserisci.png" class="img-fluid rounded-circle"
							alt=""></a>
						<h4 style="color: white">
							<a href="inserisciProd.jsp">Inserisci Prodotto</a>
						</h4>
				...
				<div class="col-sm-4">
					<div class="team-member">
						<a href="ModificaProdotto.jsp"><img
							src="img/prodotti/modifica256.png"
							class="img-fluid rounded-circle" alt=""></a>
						<h4 style="color: white">
				...
				<div class="col-sm-4">
					<div class="team-member">
						<a href="EliminaProdotto.jsp"><img
							src="img/prodotti/cancella.png" class="img-fluid rounded-circle"
							alt=""></a>
						<h4 style="color: white">
